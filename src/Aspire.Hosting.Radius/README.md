...
* `WithTerraformProviderSecret` and gateway TLS (`WithTlsCertificate`) consumers are recorded and validated but not yet emitted (`ASPIRERADIUS053`); the Radius shapes they require are not modeled yet.
